...
<head>
    ...
    <title>Editar Ítem | Transporte S.A.</title>
...
<header class="glass-effect sticky top-0 z-50 border-b border-white/20 shadow-lg">
    <div class="max-w-4xl mx-auto px-6 py-4 flex items-center justify-between">
        <div class="flex items-center space-x-4">
            ...
            <div>
                <h1 class="text-2xl font-bold text-gray-800">Editar Ítem del Checklist</h1>
                <p class="text-sm text-gray-500">Modifica la información del ítem</p>
            </div>
        </div>
...
<main class="flex-grow max-w-2xl mx-auto px-6 py-10 w-full">
    <div class="bg-white shadow-lg rounded-2xl p-8 fade-in">
        ...
        <form action="{{ route('checklist.update', $checklist) }}" method="POST">
            @csrf
            @method('PUT')
            <div>
            ...
            <div>
                ...
                <select
                    ...
                    class="w-full border border-gray-300 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-indigo-500 bg-gray-50"
                >
                    <option value="1" {{ $checklist->activo ? 'selected' : '' }}>Activo</option>
                    <option value="0" {{ !$checklist->activo ? 'selected' : '' }}>Inactivo</option>
                </select>
            </div>
...
<footer class="bg-white border-t border-gray-200 mt-16">
    <div class="max-w-4xl mx-auto px-6 py-8 text-center text-gray-600 text-sm select-none">
